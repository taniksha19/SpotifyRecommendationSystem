...
def main():
    ...
    if tracks_missing_idd > 0:
        ...
        ids_path = r'C:\Users\HP\31119_TanikshaDatar\Projects\Spotify Recommendation\output\track_ids.csv'
    ...
    path = r'C:\Users\HP\31119_TanikshaDatar\Projects\Spotify Recommendation\output\features.csv'
    ...
    df_final.to_csv(r'C:\Users\HP\31119_TanikshaDatar\Projects\Spotify Recommendation\output\final.csv')
